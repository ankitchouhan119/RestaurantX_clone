...
const h1divProps = useStore((state)=>state["Home"]["h1div"]);
const h1divIoProps = useIoStore((state)=>state["Home"]["h1div"]);
const h1divCb = useh1divCb()
...
<Div className="p-Home h1div bpt" {...h1divProps} {...h1divCb} {...h1divIoProps}>
