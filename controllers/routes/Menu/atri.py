...
class Atri:
	...
	@property
	def Link20(self):
		self._getter_access_tracker["Link20"] = {}
		return self._Link20
	@Link20.setter
	def Link20(self, new_state):
		self._setter_access_tracker["Link20"] = {}
		global default_state
		self._Link20 = Link(new_state, default_state["Link20"])
